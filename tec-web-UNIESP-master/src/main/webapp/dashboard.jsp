...
<head>
	...
	<link rel="stylesheet" 
			href="${pageContext.request.contextPath}/assets/demo/demo.css" />
</head>
...
<body class="">
		...
		<div class="sidebar" data-color="purple" data-background-color="white"
			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					...
					<li class="nav-item "><a class="nav-link" href="${pageContext.request.contextPath}/examples/user.html">
								...
								<div class="card-footer">
									<div class="stats">
										<i class="material-icons text-danger">warning</i> <a
											href="javascript:;">Get More
											Space${pageContext.request.contextPath}.</a>
									</div>
								</div>
							</div>
						</div>
			...
			<ul class="dropdown-menu">
				...
				<li class="active"><a class="img-holder switch-trigger"
					href="javascript:void(0)"> <img
						src="${pageContext.request.contextPath}/assets/img/sidebar-1.jpg"
						alt="">
				</a></li>
				<li><a class="img-holder switch-trigger"
					href="javascript:void(0)"> <img
						src="${pageContext.request.contextPath}/assets/img/sidebar-2.jpg"
						alt="">
				</a></li>
				<li><a class="img-holder switch-trigger"
					href="javascript:void(0)"> <img
						src="${pageContext.request.contextPath}/assets/img/sidebar-3.jpg"
						alt="">
				</a></li>
				<li><a class="img-holder switch-trigger"
					href="javascript:void(0)"> <img
						src="${pageContext.request.contextPath}/assets/img/sidebar-4.jpg"
						alt="">
				</a></li>
	...
	<script
		src="${pageContext.request.contextPath}/assets/js/material-dashboard.js?v=2.1.2"
